        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeItem = table.Column<string>(nullable: false),
                    CodeDict = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Producer = table.Column<string>(maxLength: 20, nullable: false),
                    Line = table.Column<string>(nullable: false),
                    Cooling = table.Column<bool>(nullable: false),
                    SocketType = table.Column<string>(nullable: false),
                    NumberOfCores = table.Column<int>(nullable: false),
                    NumberOfThreads = table.Column<int>(nullable: false),
                    ProcessorClockFrequency = table.Column<float>(nullable: false),
                    TurboMaximumFrequency = table.Column<float>(nullable: false),
                    IntegratedGraphics = table.Column<string>(nullable: true),
                    UnlockedMultiplier = table.Column<bool>(nullable: false),
                    Architecture = table.Column<int>(nullable: false),
                    TypesOfSupportedMemory = table.Column<string>(nullable: true),
                    ProductId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
